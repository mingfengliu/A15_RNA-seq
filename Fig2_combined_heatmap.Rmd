...
gene_dendro <- hclust(dist(combined_degs[remaining_genes, ], method = "euclidean"), method = "centroid")
...
# Save heatmap
pdf("/scratch/Shares/rinn/ML/RNAseq_FULL_MODEL/paper_figures/Fig2/combined_deg_lfc_heatmap_padj0.05_log2fc0.pdf", width = 20, height = 20)
